...
{
    [TestClass]
    public class LastWriteTimeNewerFileComparerTests
    {
        ...
        [TestMethod]
        public void Returns_true_if_source_is_newer()
        {
            ...
            var destinationFileInfo = new FileInformation(_destinationFileDirectory,
                _fileName, true, lastWrite: DateTimeOffset.Now.Subtract(TimeSpan.FromDays(30)));
            _mockFilesystem.FileExists(destinationFileInfo);

            IFileComparer testee = new LastWriteTimeNewerFileComparer(_mockFilesystem.Object);
        ...
        [TestMethod]
        public void Returns_false_if_source_is_older()
        {
            var sourceFileInfo = new FileInformation(_sourceFileDirectory, _fileName, true,
